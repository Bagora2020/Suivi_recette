...
class PdfChambreEtudiantController extends Controller
{
    public function index($id)
    {
        
        $invoice= ChambreEtudiant::find($id);
        $total_lettre = $this->numberToWord($invoice->montant);
        $pdf = Pdf::loadView('ordrederecettepdf.pdfChambreEtudiant', compact('invoice','total_lettre'));
