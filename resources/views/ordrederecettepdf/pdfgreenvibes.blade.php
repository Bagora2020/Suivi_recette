...
<body>
     ...
     <div class="contain">
               ...
               <tbody>
                    ...
                    <tr>
                         <td class="motif">
                              ...
                              <p>Paiement Location GreenVibes <br> Quitance N°00{{$invoice->id}}</p>
                         </td>
          ...
          <div class="text-sub-tab">
               Cette somme sera portée dans les écritures du Chef du Service du Budget au compte 707315 : Location GreenVibes
          </div>
     </div>
     <footer class="footer">
