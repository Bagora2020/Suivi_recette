...
<body>
     ...
     <div class="contain">
          ...
          <p class="text-ordre-recette">
               Le chef du Service de recouvrement du CROUS/Z est invité à recevoir de <b>{{$invoice->nomAgent}}</b> la somme de <b>{{ $total_lettre }} FCFA </b>
               <b>({{$invoice->montant}} )</b>
          </p>
          ...
          <div class="text-sub-tab">
               Cette somme sera portée dans les écritures du Chef du Service du Budget au compte 706310 : Loyers subventionnés
          </div>
     </div>
     <footer class="footer">
