...
<body>
    ...
    <div class="contain">
            ...
            <tbody>
                ...
                <tr>
                    <td class="motif">
                        ...
                        <p>Vente de tickets petit déjeuner  </p>
                    </td>
        ...
        <div class="text-sub-tab">
            Cette somme sera portée dans les écritures du Chef du Service du Budget au compte 707315 : Vente de tickets petit déjeuner
        </div>
    </div>
    <footer class="footer">
