...
<div class="mx-auto container p-3">
    <div class="card">
        <div class="card-header d-flex align-content-center justify-content-between">
            <h1 class="h2">Enregistrement Recette Cantines</h1>
        ...
        <div class="card-body">
            <form action="{{route('Cantines.add')}}" class="p-3" method="post">
                @csrf
                <div class="row mb-3">
                    ...
                    <div class="col-12 col-md-6">
                        ...
                        <input type="text" class="form-control rounded-3" placeholder="numero" name="numero">
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    <div class="col-12 col-md-6">
                        ...
                        <input type="text" name="nomLoc" class="form-control" placeholder="Date">
                    </div>
